...
\index{GraphCanvas@{GraphCanvas}!janela@{janela}}
\index{janela@{janela}!GraphCanvas@{GraphCanvas}}
\doxysubsubsection{\texorpdfstring{janela}{janela}}
{\footnotesize\ttfamily sf\+::\+Render\+Window$\ast$ Graph\+Canvas\+::janela}

T\+O\+DO Objeto Render\+Window para trabalhar no canvas. 
